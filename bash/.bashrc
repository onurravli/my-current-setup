...
#### 12/31/2022 ####
alias up='sudo pacman -Syu && sudo snap refresh && yay -Syu'
alias f='sudo sync; echo 3 | sudo tee /proc/sys/vm/drop_caches'
alias update='sudo pacman -Syu && sudo snap refresh && yay -Syu'
...
if ${use_color} ; then
	...
	if [[ ${EUID} == 0 ]] ; then
		PS1='\[\e[0;91m\][\[\e[0;91m\]\u\[\e[0;91m\]@\[\e[0;91m\]\H \[\e[0;91m\]\W\[\e[0;91m\]] \[\e[0;91m\]\$ \[\e[0m\]'
	else
